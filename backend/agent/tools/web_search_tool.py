...
class WebSearchTool(Tool):
    ...
    def __init__(self, api_key: str = None):
        ...
        self.firecrawl_api_key = getattr(config, 'FIRECRAWL_API_KEY', None)
    ...
    async def scrape_webpage(
        ...
        if not self.firecrawl_api_key:
            return self.fail_response("FIRECRAWL_API_KEY not found in configuration. Web scraping is not available.")
